...
if __name__ == '__main__':
    ...
    modelToLoad = f"../../../scratch/bazzaz.ma/NegativeExample/models/{opt.game}/{opt.epochs}/{opt.instance}/*VG.pth"
    ...
    directory = f"../../../scratch/bazzaz.ma/NegativeExample/artifacts/{opt.game}/{opt.epochs}/{opt.instance}"
