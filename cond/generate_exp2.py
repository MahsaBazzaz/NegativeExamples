...
if __name__ == '__main__':
    ...
    modelToLoad = f"{opt.directory}/models/exp2/{opt.game}/{opt.instance}/{opt.epochs}/CondG*_{opt.cond}.pth"
    ...
    labels = torch.FloatTensor(np.tile([[opt.condition, 0]], (batch_size, 1)))
    ...
    directory = f"{opt.directory}/artifacts/exp2/{opt.game}/{opt.instance}/{opt.epochs}/Cond/{opt.cond}"
