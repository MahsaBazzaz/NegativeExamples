...
for epoch in range(epochs + 1):
    ...
    if epoch % 100 == 0 and epoch > 0:
        ...
        torch.save(netG.state_dict(), f'{main_dir}/{opt.s + epoch}/CondG_{opt.cond}_checkpoint_{opt.s + epochs}.pth')
        torch.save(netD.state_dict(), f'{main_dir}/{opt.s + epoch}/CondD_{opt.cond}_checkpoint_{opt.s + epochs}.pth')
