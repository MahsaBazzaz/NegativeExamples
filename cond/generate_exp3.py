...
if __name__ == '__main__':
    ...
    modelToLoad = f"{opt.directory}/models/exp3/{opt.game}/{opt.instance}/{opt.epochs}/CondG*_{opt.cond}.pth"
    ...
    directory = f"{opt.directory}/artifacts/exp3/{opt.game}/{opt.instance}/{opt.epochs}/Cond/{opt.cond}"
