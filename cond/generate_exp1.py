...
if __name__ == '__main__':
    ...
    modelToLoad = f"{opt.directory}/models/exp1/{opt.game}/{opt.instance}/{opt.epochs}/CondG*.pth"
    ...
    labels = torch.FloatTensor(np.tile([[random.choice([1, 2, 3]), 0]], (batch_size, 1)))
    ...
    directory = f"{opt.directory}/artifacts/exp1/{opt.game}/{opt.instance}/{opt.epochs}/Cond"
