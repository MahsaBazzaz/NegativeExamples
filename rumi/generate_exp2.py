...
if __name__ == '__main__':
    ...
    modelToLoad = f"{opt.directory}/models/{opt.game}/{opt.instance}/{opt.epochs}/RG*_{opt.cond}.pth"
    ...
    directory = f"{opt.directory}/artifacts/{opt.game}/{opt.instance}/{opt.epochs}/R_{opt.epochs}"
