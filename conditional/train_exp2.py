...
for epoch in range(epochs + 1):
    ...
    if epoch % 100 == 0 and epoch > 0:
        ...
        torch.save(netG.state_dict(), f'{main_dir}/{epoch + opt.s}/CG_{opt.cond}_checkpoint_{epochs + opt.s}.pth')
        torch.save(netD.state_dict(), f'{main_dir}/{epoch + opt.s}/CD_{opt.cond}_checkpoint_{epochs + opt.s}.pth')
